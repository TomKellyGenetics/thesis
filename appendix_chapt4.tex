...
%\begin{mdframed}
  ...
  \resizebox{0.95 \textwidth}{!}{
   ...
   \end{center}
   \caption[Synthetic Lethality and Centrality]{\small \textbf{Synthetic Lethality and Centrality.}  The information centrality was compared (on a log-scale across genes deteced by mtSLIPT and \gls{siRNA} screening in the Reactome PI3K cascade pathway. Genes detected by mtSLIPT or \gls{siRNA} did not have higher connectivity than genes not detected by either approach. The gene with the highest centrality was detected by \gls{siRNA}.
}
