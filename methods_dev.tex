...
%\begin{mdframed}
  ...
  %\fbox{
   ...
   \end{center}
   \caption[Performance of binomial simulations]{\small \textbf{Performance of binomial simulations.} Gene function was simulated by binomial sampling and tested for \glspl{synthetic lethal} by \gls{SLIPT}. Statistical performance declined with additional known \gls{synthetic lethal} partners but this was mitigated by increased sample sizes.}
