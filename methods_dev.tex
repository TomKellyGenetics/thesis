...
The SLIPT methodology is amenable for use on expression data including pathway metagenes (as generated in Section~\ref{methods:metagene}). The suitability of the SLIPT methodology to application on public gene expression data will further be supported by simulation results in Section~\ref{chapt2:simulation_2015} and Chapter~\ref{chap:simulation}, including comparison to other statistical methods. SLIPT results for \textit{CDH1} will also compared experimental screen results in a breast cell line \citep{Telford2015}, primary screen results are discussed in Section~\ref{chapt3:compare_SL_genes} and secondary (validation) screen results are presented in Appendix~\ref{appendix:secondary_screen}.
