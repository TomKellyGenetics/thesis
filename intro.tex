...
The occurrence of \glslink{somatic}{somatic} \glspl{mutation} \textcolor{red}{throughout our lifespan} increases the risk of \gls{cancer} with age. An association of cancer incidence with the stem cell divisions in which \glspl{mutation} could occur across tissue types, suggests that cancers may be inseparably coupled with aging \citep{Tomasetti2015}.  
...
\textcolor{red}{For instance, patient outcome and quality of life could be more improved by more precise diagnosis of tumour subtype or tailored treatment based on molecular diagnosis, including targeted therapeutics with fewer adverse effects \citep{ONeil2017, Kaelin2005}.} 
...
maintain the \textcolor{red}{Catalogue Of Somatic Mutations In Cancer} (COSMIC), a database of \glspl{cancer gene} \citep{COSMICdb}. %This launched with 66,634 samples and 10,647 \glspl{mutation} from initial investigations into \textit{BRAF}, HRAS, \textit{KRAS}, and NRAS \citep{Bamford2004}.
