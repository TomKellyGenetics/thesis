...
\Gls{genomic} technologies have transformed genetics research, including the study of health and disease \citep{Lander2011, Goodwin2016}. \Glspl{genomic} enables systematic, unbiased studies across all of the genes in the genome. Cancer \glspl{genomic} investigations have been widely applied to different tissues across molecular profiles \citep{Bamford2004, ICGC2011, TCGA2013PAN}. Genome sequencing technologies continue to improve and become  feasible in a wider range of applications.
...
\gls{NGS} is highly adaptable to different applications, including DNA sequencing (whole \glslink{genomic}{genome} or \gls{exome}), DNA methylation (\gls{bisulfite-Seq}), or \gls{RNA-Seq} \citep{Waldron2016, Goodwin2016, Tran2012}. %, \gls{miRNA}, \gls{lncRNA}, or \gls{ChIP}.
\gls{RNA-Seq} of the \gls{transcriptome} is a common adaptation where \gls{RNA} is reverse transcribed and sequenced from the resulting \gls{cDNA}. This is utilised to quantify the levels of \gls{RNA} and identify which regions of DNA are expressed. Similarly, bisulfite treatment converts cytosine residues to uracil% (sequenced as thymidine)
...
Cancers could eventually be treated by their genomic features \citep{Roychowdhury2016}, particularly grouping patients by the mutation, expression, or DNA methylation profiles of their cancers, which is already done in part \citep{Parker2009}. 
