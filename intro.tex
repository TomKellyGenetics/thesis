...
\begin{itemize}
 \item describe/define
 \item incidence / prevalence / morality (global)
 \item incidence / prevalence / morality (NZ)
 \item Current diagnostics: largely pathological
 \item Current treatment: surgery, radiation, chemotherapy
\end{itemize}

\subsubsection{Genetics and Molecular Biology in Cancers}

\begin{itemize}
 \item Genetics and Heredity of Cancers
 \item Hallmarks of Cancer
 \item Intrinsic subtyping and Pan cancer approaches
\end{itemize}
...
\subsubsubsection{Findings of the TCGA and ICGC Projects}
Text 
