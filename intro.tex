...
To demonstrate the \gls{SLIPT} methodology for analysis of \gls{RNA-Seq} \gls{gene expression} data, an analysis was performed in Chapter~\ref{chap:SLIPT} to identify candidate \gls{synthetic lethal} gene partners of \textit{CDH1} in public breast and stomach cancer data \citep{TCGA2012, TCGA2014GC}. This analysis demonstrates the biological relevance of candidate \gls{synthetic lethal} partners by identifying \gls{synthetic lethal} pathways with comparisons to an experimental \gls{siRNA} screen \citep{Telford2015}.
