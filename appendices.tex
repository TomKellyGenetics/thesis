...
%\begin{mdframed}
  ...
  \resizebox{0.3\textwidth}{!}{
    ...
    \caption[Replicate excluded samples]{\small \textbf{Replicate excluded samples.} Both tumour samples of patient A2QH were excluded as they were poorly correlated with other samples, although they are highly similar to each other as shown by Pearson correlation of log-raw counts.
}
...
\begin{table*}[!ht]
\caption{Candidate synthetic lethal genes against \gls{E-cadherin} from mtSLIPT}
\label{tab:gene_mtSL}
\centering
...
\begin{tablenotes}
\raggedright \small
Strongest candidate SL partners for \textit{CDH1} by \acrshort{mtSLIPT} with observed and expected mutant samples with low expression of partner genes
\end{tablenotes}
\end{threeparttable}
}
\end{table*}
...
\begin{table*}[!hp]
\caption{Pathway composition for \textit{CDH1} partners from \acrshort{mtSLIPT} and \gls{siRNA}}
...
\rowcolor{black!5}
  ...
  \rowcolor{black!10}
  Cytosolic \acrshort{tRNA} aminoacylation & 379716 & 75 & 36.70 & 69.56 & $7.8573 \times 10^{-16}$ & $1.4396 \times 10^{-130}$\\
  \rowcolor{black!5}
  ...
  \rowcolor{black!10}
  \acrshort{DNA} Replication Pre-Initiation & 69002 & 74 & 36.70 & 68.16 & $1.5826 \times 10^{-15}$ & $1.8641 \times 10^{-130}$\\
  \rowcolor{black!5}
  ...
  \rowcolor{black!10}
  \acrshort{DNA} Replication & 69306 & 72 & 36.70 & 62.51 & $2.6652 \times 10^{-14}$ & $2.0427 \times 10^{-120}$\\
  \rowcolor{black!5}
...
\begin{tablenotes}
\raggedright \small
Strongest candidate SL partners for \textit{CDH1} by \acrshort{mtSLIPT} with observed and expected mutant samples with low expression of partner metagenes
\end{tablenotes}
\end{threeparttable}
}
\end{table*}
...
\begin{table*}[!ht]
\caption{Candidate synthetic lethal genes against \gls{E-cadherin} from \acrshort{mtSLIPT} in stomach cancer}
...
\rowstyle{\bfseries}
  ...
  \rowcolor{Cluster_Red!15} 
  Viral \acrshort{mRNA} Translation & $2.5 \times 10^{-124}$ & $<8.802 \times 10^{-4}$ \\ 
  \rowcolor{Cluster_Red!20} 
  ...
  \rowcolor{Cluster_Red!20} 
  Influenza Viral \acrshort{RNA} Transcription and Replication & $5.1 \times 10^{-103}$ & $<8.802 \times 10^{-4}$ \\ 
  \rowcolor{Cluster_Red!15} 
  ...
  \rowcolor{Cluster_Red!20} 
  GPCR downstream signalling & $1 \times 10^{-80}$ & $0.034498$ \\ 
  \rowcolor{Cluster_Red!15} 
  ...
  \rowcolor{Cluster_Red!15} 
  Platelet activation, signalling and aggregation & $2.7 \times 10^{-55}$ & $0.081717$ \\ 
  \rowcolor{Cluster_Red!20} 
  GPCR ligand binding & $7.3 \times 10^{-55}$ & $0.28898$ \\ 
  \rowcolor{Cluster_Red!15} 
  Signalling by PDGF & $8.4 \times 10^{-55}$ & $0.16025$ \\ 
  \rowcolor{Cluster_Red!20} 
  Class A/1 (Rhodopsin-like receptors) & $3.2 \times 10^{-54}$ & $0.22801$ \\ 
  \rowcolor{Cluster_Red!15} 
  Fc epsilon receptor (FCERI) signalling & $6.2 \times 10^{-53}$ & $0.15229$ \\ 
  \rowcolor{Cluster_Red!20} 
  Adaptive Immune System & $5.1 \times 10^{-52}$ & $0.037698$ \\ 
  \rowcolor{Cluster_Red!15} 
  Signalling by ERBB4 & $5.9 \times 10^{-52}$ & $0.10088$ \\ 
  \rowcolor{Cluster_Red!20} 
  ...
  \rowcolor{Cluster_Red!15} 
  \begin{tabular}[c]{@{}l@{}}Activation of the \acrshort{mRNA} upon binding of the cap-binding complex and eIFs,\\and subsequent binding to 43S \end{tabular} & $7.1 \times 10^{-50}$ & $0.0017305$ \\ 
  \rowcolor{Cluster_Red!20} 
  Transmembrane transport of small molecules & $1.8 \times 10^{-49}$ & $0.081229$ \\ 
  \rowcolor{Cluster_Red!15} 
  Signalling by ERBB2 & $5.9 \times 10^{-49}$ & $0.11896$ \\ 
  \rowcolor{Cluster_Red!20} 
  ...
  \rowcolor{Cluster_Red!15} 
  Signalling by FGFR & $1.7 \times 10^{-47}$ & $0.11896$ \\ 
  \rowcolor{Cluster_Red!20} 
  Signalling by FGFR1 & $1.7 \times 10^{-47}$ & $0.11896$ \\ 
  \rowcolor{Cluster_Red!15} 
  Signalling by FGFR2 & $1.7 \times 10^{-47}$ & $0.11896$ \\ 
  \rowcolor{Cluster_Red!20} 
  Signalling by FGFR3 & $1.7 \times 10^{-47}$ & $0.11896$ \\ 
  \rowcolor{Cluster_Red!15} 
  Signalling by FGFR4 & $1.7 \times 10^{-47}$ & $0.11896$ \\ 
  \rowcolor{Cluster_Red!20} 
  DAP12 interactions & $1.9 \times 10^{-47}$ & $0.28811$ \\ 
  \rowcolor{Cluster_Red!15} 
  DAP12 signalling & $1 \times 10^{-46}$ & $0.12442$ \\ 
  \hline
\end{tabular}
\begin{tablenotes}
\raggedright \small
...
\rowstyle{\bfseries}
  ...
  \hline
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  Signalling by NOTCH4 & $4.9 \times 10^{-6}$ & $0.050121$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  HS-GAG degradation & $4.9 \times 10^{-6}$ & $0.013193$ \\ 
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  Platelet activation, signalling and aggregation & $4.9 \times 10^{-6}$ & $0.28053$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  ...
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  Signalling by PDGF & $2.9 \times 10^{-5}$ & $0.43907$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  Circadian Clock & $2.9 \times 10^{-5}$ & $0.012519$ \\ 
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  Signalling by ERBB4 & $4.3 \times 10^{-5}$ & $0.12835$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  ...
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  Signalling by NOTCH & $4.5 \times 10^{-5}$ & $0.10912$ \\ 
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  G_${\alpha q}$ signalling events & $5.1 \times 10^{-5}$ & $0.28937$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  Signalling by ERBB2 & $7.1 \times 10^{-5}$ & $0.50797$ \\ 
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  Response to elevated platelet cytosolic Ca$^{2+}$ & $7.1 \times 10^{-5}$ & $0.38513$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  Signalling by SCF-KIT & $8.3 \times 10^{-5}$ & $0.55412$ \\ 
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  PI3K events in ERBB4 signalling & $0.0001$ & $0.24486$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  PIP3 activates AKT signalling & $0.0001$ & $0.24486$ \\ 
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  Collagen formation & $0.0001$ & $0.15296$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  PI3K events in ERBB2 signalling & $0.0001$ & $0.24486$ \\ 
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  ...
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  Growth hormone receptor signalling & $0.0001$ & $0.057494$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  ...
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  Integrin alphaIIb beta3 signalling & $0.00016$ & $0.63007$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  Interferon gamma signalling & $0.00018$ & $0.43088$ \\ 
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  ...
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  Signalling by activated point mutants of FGFR1 & $0.00029$ & $0.24892$ \\ 
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  FGFR1c ligand binding and activation & $0.00029$ & $0.24892$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  Signalling by NOTCH3 & $0.00029$ & $0.017419$ \\ 
  \hline
\end{tabular}
\begin{tablenotes}
\raggedright \small
...
\rowstyle{\bfseries}
 Pathway & ID & Observed & Expected & $\chi^2$value & p-value & p-value (\gls{FDR}) \\
  ...
  \rowcolor{black!10}
  Signalling by SCF-KIT & 1433557 & 5 & 10.07 & 20.64 & $3.3045 \times 10^{-5}$ & $0.00642330$\\
  \rowcolor{black!5}
  ...
  \rowcolor{black!5}
  p130Cas linkage to MAPK signalling for integrins & 372708 & 2 & 10.07 & 19.08 & $7.1872 \times 10^{-5}$ & $0.00651340$\\
  \rowcolor{black!10}
  cGMP effects & 418457 & 8 & 10.07 & 19.01 & $7.4597 \times 10^{-5}$ & $0.00651340$\\
  \rowcolor{black!5}
   \begin{tabular}[c]{@{}l@{}}Regulation of cytoskeletal remodelling and cell spreading by IPP \\ complex components \end{tabular} & 446388 & 8 & 10.07 & 19.01 & $7.4597 \times 10^{-5}$ & $0.00651340$\\
  \rowcolor{black!10}
  ...
  \rowcolor{black!10}
  Signalling by VEGF & 194138 & 7 & 10.07 & 17.90 & $0.00012995$ & $0.00651340$\\
  \rowcolor{black!5}
  ...
  \rowcolor{black!10}
  Termination of translesion \acrshort{DNA} synthesis & 5656169 & 20 & 10.07 & 17.46 & $0.00016155$ & $0.00651340$\\
  \rowcolor{black!5}
  PI3K events in ERBB4 signalling & 1250342 & 4 & 10.07 & 17.26 & $0.00017862$ & $0.00651340$\\
  \rowcolor{black!5}
  PIP3 activates AKT signalling & 1257604 & 4 & 10.07 & 17.26 & $0.00017862$ & $0.00651340$\\
   \hline
\end{tabular}
\begin{tablenotes}
\raggedright \small
