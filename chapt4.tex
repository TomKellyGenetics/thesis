...
The investigations in theis chapter considered \gls{synthetic lethal} gene candidates within \glslink{graph}{pathway} structures, including whether the discrepancy between individual \gls{SLIPT} and \gls{siRNA} candidate genes could be accounted for, within a \gls{synthetic lethal} \gls{pathway}.
%
