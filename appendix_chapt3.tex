...
\section{Synthetic Lethal Genes and Pathways} \label{results:mtSL_genes}

SLIPT expression analysis (described in section \ref{methods:SLIPT}) on TCGA breast cancer data ($n = 969$) found the following genes and pathways, described in sections \ref{results:exprSL_genes} and \ref{results:exprSL_pathways}.
...
\clearpage
\section{Compare SLIPT genes} \label{chapt3:compare_mtSL}}
...
\section{Metagene Analysis} \label{chapt3:metagene_stad_mtSL}
