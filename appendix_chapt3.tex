...
\noindent\fbox{\begin{minipage}{1.15 \textwidth}  %frame beyond textwidth
\begin{center}
  \resizebox{1 \textwidth}{!}{
...
The following chapt3: are a replication of the TCGA chapt3: (in Chapter 4) with stomach cancer data, using synthetic lethality (SLIPT) against \textit{CDH1} mutation.
...
\rowstyle{\bfseries}
  ...
  \rowcolor{Cluster_Red!15} 
  Signaling by Wnt & $8.7 \times 10^{-57}$ & $0.25468$ \\ 
 \hline
\end{tabular}
\begin{tablenotes}
\raggedright \small
...
\rowstyle{\bfseries}
  ...
  \hline
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  Platelet activation, signaling and aggregation & $3.9 \times 10^{-9}$ & $0.49557$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
  ...
  \rowcolor{Cluster_Red!20!Cluster_Blue!20} 
  G_${\alpha i}$ signalling events & $9.8 \times 10^{-7}$ & $0.99626$ \\ 
  \rowcolor{Cluster_Red!15!Cluster_Blue!15} 
...
The following chapt3: are a replication of the TCGA chapt3: (in Appendix \ref{appendix:mtSL}) with stomach cancer data, using synthetic lethality (mtSLIPT) against \textit{CDH1} mutation.
...
\rowstyle{\bfseries}
 Pathway & ID & Observed & Expected & $\chi^2$value & p-value & p-value (FDR) \\
  \hline
  \rowcolor{black!10}
  \cellcolor{white} Prostacyclin signalling through prostacyclin receptor & 392851 & 1 & 10.1 & 26.5 & $1.73 \times 10^{-6}$ & $0.00286$ \\ 
  \rowcolor{black!5}
  ...
  \rowcolor{black!10}
  Signaling by SCF-KIT & 1433557 & 5 & 10.1 & 20.6 & $3.30 \times 10^{-5}$ & $0.00642$ \\ 
  \rowcolor{black!5}
  VEGFA-VEGFR2 Pathway & 4420097 & 5 & 10.1 & 20.6 & $3.30 \times 10^{-5}$ & $0.00642$ \\ 
  \rowcolor{black!10}
  p130Cas linkage to MAPK signaling for integrins & 372708 & 2 & 10.1 & 19.1 & $7.19 \times 10^{-5}$ & $0.00651$ \\ 
  \rowcolor{black!5}
...
\begin{tabular}{lcccc}
  ...
  \rowcolor{black!10}
  Signaling by BMP &  23 &   5 & $3.7 \times 10^{-11}$ & $3.2 \times 10^{-9}$ \\ 
  \rowcolor{black!5}
