...
\newacronym[description={microRNA}]{miRNA}{miRNA}{micro RNA}
...
\newacronym[description={Progesterone receptor}]{ER}{ER}{Progesterone receptor}

\newacronym[description={False discovery rare}]{FDR}{FDR}{False discovery rate}
...
\newacronym[description={Area under the receiver operating characteristic (curve)}]{AUROC}{AUROC}{area under the receiver operating characteristic}
...
\newacronym[description={synthetic genetic interaction}, plural=SGI,firstplural=synthetic genetic interactions]{SGI}{SGIs}{synthetic genetic interaction}
