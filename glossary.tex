...
\newglossaryentry{methylation}{%
  name=methylation,
  description={A measure of the epigenetic regulation of DNA at \gls{CpG} sites},
  plural=methylation
}
...
\newglossaryentry{chemoprevention}{%
  ...
  description={The use of cytotoxic drugs to prevent early-stage cancers, generally applied to high-risk mutation carriers},
