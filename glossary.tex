...
\newglossaryentry{Pan cancer}{
  name=Pan cancer,
  description={Study or analysis orf cancers across tissue of origin}
}
...
\newglossaryentry{genome}{
  name=genome,
  description={An analysis of all of the DNA sequence in the genome},
  plural=genomes
}
...
\newglossaryentry{transcriptome}{
  name=transcriptome,
  description={An analysis of all of the genes expressed in the genome},
  plural=transcriptomics
}

\newglossaryentry{metagenomics}{
  name=metagenomics,
  description={An analysis of all of the genes and genomes in a community},
...
\newglossaryentry{functional redundancy} %genetic redundancy
{
...
\newacronym[description={G Crotein Coupled Receptor}, plural=GPCRs,firstplural=G protein coupled receptors]{GPCR}{GPCR}{G protein coupled receptor}%

\newacronym[description={\acrshort{AMP}-activated Protein Kinase}]{AMPK}{AMPK}{\acrshort{AMP}-activated protein kinase}%
...
\newacronym[description={Messenger Ribonucleic Acid}]{mRNA}{mRNA}{messenger RNA}%

\newacronym[description={Micro RNA}]{miRNA}{miRNA}{micro RNA}%

\newacronym[description={Short Interfering Ribonucleic Acid}, plural=siRNAs,firstplural=siRNAs]{siRNA}{siRNA}{short interfering RNA}%

\newacronym[description={Short Hairpin Ribonucleic Acid}, plural=shRNAs,firstplural=shRNAs]{shRNA}{shRNA}{short hairpin RNA}%

\newacronym[description={Ribonucleic acid}]{rRNA}{rRNA}{RNA}%

\newacronym[description={Transfer Ribonucleic Acid}]{tRNA}{tRNA}{transfer RNA}%

\newacronym[description={Complementary Deoxyribonucleic Acid (from mRNA)}]{cDNA}{cDNA}{complementary DNA}%
...
\newacronym[description={Long Non-Coding Ribonucleic Acid}]{lncRNA}{lncRNA}{long non-coding RNA}%
...
\newacronym[description={Cylic \acrshort{AMP}}]{cAMP}{cAMP}{cylic \acrshort{AMP}}%
...
\newacronym[description={Poly-\acrshort{ADP}-Ribose Polymerase}]{PARP}{PARP}{Poly-\acrshort{ADP}-ribose polymerase}%
...
\newacronym[description={Synthetic Lethal Interaction Prediction Tool (with respect to mutation)}]{mtSLIPT}{mtSLIPT}{mutation SLIPT}%
...
\newacronym[description={Area Under the Receiver Operating Characteristic (curve)}]{AUROC}{AUROC}{area under \gls{ROC}}%

\newacronym[description={Reciever Pperating Characteristic (curve)}]{ROC}{ROC}{receiver operating characteristic}%
