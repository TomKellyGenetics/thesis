...
%
        \subcaptionbox{Performance of $\chi^2$ and SLIPT}{%
            ...
            \includegraphics[width=0.6\textwidth]{{"/home/tomkelly/Documents/PhD Otago Uni/SL_Model/RUN_20161108/SL_Model_Test_Graph_10K_Graph5_ROC_Cor_v_nCor_All(5)".png}}
        }%
      ...
      \end{center}
      \caption[Performance on Graph Structures]{\textbf{Performance on Graph Structures}. Synthetic Lethal Detection Compared with $\chi^$.}
    \label{fig:fig:simulation1108_Graph5All5SL}
    \end{mdframed}
    \end{figure*}
...
%
        ...
        %}%
      \end{center}
      \caption[Performance on Graph Structures]{\textbf{Performance on Graph Structures}. Synthetic Lethal Detection Compared with $\chi^$ with more genes.}
...
%
        ...
        %}%
      \end{center}
      \caption[Performance on Graph Structures]{\textbf{Performance on Graph Structures}. Synthetic Lethal Detection Compared with $\chi^$ with query correlation genes.}
    \label{fig:simulation1107_Graph5All5SL}
    \end{mdframed}
    \end{figure*}
...
%
        ...
        %}%
      \end{center}
      \caption[Performance on Graph Structures]{\textbf{Performance on Graph Structures}. Synthetic Lethal Detection Compared with $\chi^$ with query correlation and more genes.}
    \label{fig:simulation1107_Graph5All5SL}
    \end{mdframed}
    \end{figure*}
...
Text
    ...
    \label{fig:fig:simulation1205_randx_Graph4cfnCor}
    \end{mdframed}
    \end{figure*}
