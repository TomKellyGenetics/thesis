...
\resizebox{\textwidth}{!}{
      \begin{tabular}{|c|c|c|c|c|c|c|c|c|ccc|}
        \hline
        Tissue Source		& Type   & Batch & Plate & Patient & Samples & p53      & Subtype   & Treatment (History) 			& \multicolumn{3}{ c| }{Clinical (Stage)} \\
\hline
...
%\cline{2-5}
\multicolumn{1}{r}{}                        & \multicolumn{1}{l}{Viao Laptop}                                     & \multicolumn{1}{l}{Lab Machine}                                   & \multicolumn{1}{l}{Biochem Server}                                     & \multicolumn{1}{l}{NeSI Pan Cluster}                               \\
\cline{2-5}
...
%\cline{3-6}
\cellcolor{white}                                                      & \multicolumn{1}{l}{}                         & \multicolumn{1}{l}{Viao Laptop}                                     & \multicolumn{1}{l}{Lab Machine}                                    & \multicolumn{1}{l}{Biochem Server}                                    & \multicolumn{1}{l}{NeSI Pan Cluster}                               \\
\cline{2-6}
\rowcolor{gray!25}
...
\begin{tabular}{ll|l|l|l|l|}
%\cline{3-6}
                                        & \multicolumn{1}{l}{}              & \multicolumn{1}{l}{Viao Laptop}                                     & \multicolumn{1}{l}{Lab Machine}                                    & \multicolumn{1}{l}{Biochem Server}                                    & \multicolumn{1}{l}{NeSI Pan Cluster}           \\
\cline{2-6}
...
%\cline{2-4}
\multicolumn{1}{l}{}           & \multicolumn{1}{l}{Package Name}         & \multicolumn{1}{l}{Description                                                             and GitHub Repository}                                                                   & \multicolumn{1}{l}{Description in Thesis} \\
\cline{2-4}  \rowcolor{gray!25} \cellcolor{white}
                               & \multicolumn{1}{l|}{\texttt{slipt}}      & \begin{tabular}[c]{@{}l@{}}Synthetic lethal detection by SLIPT (to accompany publication)  \\ \url{https://github.com/TomKellyGenetics/slipt}                         \end{tabular} & Section \ref{methods:SLIPT}  \\
\hline
...
\rowcolor{gray!25} \cellcolor{white}
                               & \texttt{heatmap.2x}                      & \begin{tabular}[c]{@{}l@{}}Customised heatmaps (based on \texttt{gplots})                  \\ \url{https://github.com/TomKellyGenetics/heatmap.2x}                    \end{tabular} & Section \ref{methods:heatmap} \\
\hline
\texttt{igraph.extensions}     & \texttt{igraph.extensions}               & \begin{tabular}[c]{@{}l@{}}Meta-package to install the follow iGraph functions             \\ \url{https://github.com/TomKellyGenetics/igraph.extensions}             \end{tabular} & Section \ref{methods:igraph_extensions}    \\
\cline{2-4}

\rowcolor{gray!25} \cellcolor{white}
                               & \texttt{plot.igraph}                     & \begin{tabular}[c]{@{}l@{}}Custom plotting of directed graphs                              \\ \url{https://github.com/TomKellyGenetics/plot.igraph}                   \end{tabular} & Section \ref{methods:network_metrics}      \\
\cline{2-4}
                               & \texttt{info.centrality}                 & \begin{tabular}[c]{@{}l@{}}Computing information centrality from network efficiency        \\ \url{https://github.com/TomKellyGenetics/info.centrality}               \end{tabular} & Section \ref{methods:graphsim}\\
\cline{2-4}

\rowcolor{gray!25} \cellcolor{white}
                               & \texttt{pathway.structure.permutation}   & \begin{tabular}[c]{@{}l@{}}Testing pathway structure with resampling analysis              \\ \url{https://github.com/TomKellyGenetics/pathway.structure.permutation} \end{tabular} & Section \ref{methods:network_permutation}  \\
\cline{2-4}
                               & \texttt{graphsim}                        & \begin{tabular}[c]{@{}l@{}}Generating simulated expression from graph structures           \\ \url{https://github.com/TomKellyGenetics/graphsim}                      \end{tabular} & Section \ref{methods:graphsim}\\
\hline 
\end{tabular} 
}
\end{table}
