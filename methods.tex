...
The microarray expression data sourced from the CCLE was used as provided, using the Robust Multi-array Average (RMA) and normalized by quantile normalization.
...
\multicolumn{1}{l|}{\cellcolor{white}}           & \multicolumn{1}{l}{\texttt{slipt}}        & \begin{tabular}[c]{@{}l@{}}Synthetic lethal detection by SLIPT (to accompany publication)  \\ \url{https://github.com/TomKellyGenetics/slipt}                         \end{tabular} &~\ref{methods:SLIPT}  \\
\hline
