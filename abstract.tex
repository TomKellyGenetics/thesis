...
Thus this thesis has developed, evaluated, and refined a bioinformatics approach to discovery of synthetic lethal genes solely from gene expression data. This approach has been demonstrated to detect biologically informative and clinically relevant candidate synthetic lethal partners for \textit{CDH1} in breast and stomach cancers. These investigations have also involved the development of network analysis and simulation procedures which may be more widely applicable.
...
The \href{https://github.com/TomKellyGenetics/slipt-app}{\texttt{slipt-app}} GitHub repository also hosts an application for \gls{SLIPT} developed in the R \texttt{shiny} environment as part of a related project. There is a digital copy of this thesis, including high resolution full-colour figures, hosted at:
