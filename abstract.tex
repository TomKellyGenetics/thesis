...
However, \acrshort{SLIPT} genes had lower centrality and were upstream of \acrshort{siRNA} candidates, specifically in the $G_{\alpha i}$ signalling pathway.
%chapt 5
